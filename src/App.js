...
import GoogleCalendarEventCreate from './component/GoogleCalendarEventCreate/GoogleCalendarEventCreate';
                ...
                {isLoggedIn ? (
                    <>
                        ...
                        <div className="account-container">
                            ...
                            <Toggle status={isDark} method={handleDarkToggle} labels={['Dark', 'Light']}/>
                        </div>
                    </>
                ) : (
                    <div></div>
